...
public:
    ...
    void SetItemStabilization(bool On);
    ...
    UFUNCTION(BlueprintCallable, BlueprintNativeEvent)
    void RequestItemChangeCollisionProfile(bool bAttached);
    ...
    UFUNCTION(BlueprintCallable, BlueprintNativeEvent)
    TArray<AActor*> GetAttachments(bool bIncludeChildren, bool bIncludeHolders);
    ...
    UFUNCTION(BlueprintCallable, BlueprintNativeEvent)
    bool CanGrip(FGameplayTagContainer GripTags, UGripMotionControllerComponent* MotionController);
