...
public:
    ...
    static void UpdateIgnoreCollisionForItemActorAttachments(AActor* ItemActor);
    ...
    static bool IsItemTrashMarked(UObject* WorldContext, AActor* Item);
    ...
    UFUNCTION(BlueprintCallable)
    static void DisableItemPrimitivesCollision(AActor* ItemActor);
    ...
    UFUNCTION(BlueprintCallable)
    static TArray<USceneComponent*> AddStartingGearToDynamicData(APawn* PlayerPawn, const bool bIsLeftHanded);
