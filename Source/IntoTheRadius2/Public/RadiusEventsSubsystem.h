...
#include "OnContainerChangeParentDelegate.h"
...
#include "OneParamUniqueNetIdReplDelegateDelegate.h"
...
public:
    ...
    UPROPERTY(BlueprintAssignable, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FOnContainerChangeParent OnContainerChangeParent;
    
    UPROPERTY(BlueprintAssignable, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FContainerIDParamDelegate OnContainerChildrenChange;
    ...
    UPROPERTY(BlueprintAssignable, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FOneParamUniqueNetIdReplDelegate OnPlayerConnected;
    
    UPROPERTY(BlueprintAssignable, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FOneParamUniqueNetIdReplDelegate OnPlayerDisconnected;
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure=false)
    void FireOnPlayerDisconnected(FUniqueNetIdRepl UniqueNetId) const;
    
    UFUNCTION(BlueprintCallable, BlueprintPure=false)
    void FireOnPlayerDeathPointsChanged() const;
    
    UFUNCTION(BlueprintCallable, BlueprintPure=false)
    void FireOnPlayerConnected(FUniqueNetIdRepl UniqueNetId) const;
