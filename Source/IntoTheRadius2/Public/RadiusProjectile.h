...
public:
    ...
    UFUNCTION(BlueprintCallable)
    void InitializeWithData(const FAmmoStaticData& InAmmoStaticData, const float InVelocity, const float DamageModifier, const bool bForceTracer, AActor* NewOwner) override PURE_VIRTUAL(InitializeWithData,);
