...
public:
    ...
    UFUNCTION(BlueprintCallable, meta=(WorldContext="WorldContextObject"))
    static void ShowSubtitles(const UObject* WorldContextObject, const TEnumAsByte<ESubtitleInstigator> SubtitleInstigator, const FText& Message, float Duration);
