...
public:
    ...
    UFUNCTION(BlueprintCallable)
    virtual void InitializeWithData(const FAmmoStaticData& InAmmoStaticData, const float InVelocity, const float DamageModifier, const bool bForceTracer, AActor* Owner) PURE_VIRTUAL(InitializeWithData,);
