...
void URadiusCheatSubsystem::SetAccessLevel(int32 AccessLevel) const {
}
...
bool URadiusCheatSubsystem::IsAIDebug() const {
    return false;
}
...
void URadiusCheatSubsystem::AddAccessPoints(int32 AccessPoints) const {
}
