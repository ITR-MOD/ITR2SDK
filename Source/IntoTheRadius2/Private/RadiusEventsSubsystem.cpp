...
void URadiusEventsSubsystem::FireOnPlayerDisconnected(FUniqueNetIdRepl UniqueNetId) const {
}

void URadiusEventsSubsystem::FireOnPlayerDeathPointsChanged() const {
}

void URadiusEventsSubsystem::FireOnPlayerConnected(FUniqueNetIdRepl UniqueNetId) const {
}
