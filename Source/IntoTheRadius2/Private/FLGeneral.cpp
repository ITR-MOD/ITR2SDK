...
void UFLGeneral::ShowSubtitles(const UObject* WorldContextObject, const TEnumAsByte<ESubtitleInstigator> SubtitleInstigator, const FText& Message, float Duration) {
}
