...
TArray<int32> ARadiusGameDataReplicator::GetNewItemLabelCounters() {
    return TArray<int32>();
}
...
URadiusItemDynamicData* ARadiusGameDataReplicator::GetItemDynamicDataByUid(const FString& ItemUid) {
    return NULL;
}
